...
public class Controller : MonoBehaviour
{
   ...
   void createBlocks()
   {
       ...
       //create (gameObject.prefab = "bananaPrefab");
   ...
   bool anyBlocksLeft()
   {
    ...
    GameObject[] Variableblock = GameObject.FindGameObjectsWithTag("block");
	if(Variableblock.Length <= 0)
	{
		return false;
	}
	   GameObject[] blockVariable = GameObject.FindGameObjectsWithTag("block");
	if(Variableblock.Length >= 0)
	{
		return true;
	}
